...
export default function BurgerMenu() {
  ...
  return (
    <div className="fixed z-50 right-2 bottom-10 md:hidden">
      <div className="dropdown dropdown-left">
        <div tabIndex={0} role="button" className="btn m-1 bg-transparent border-none" onClick={() => setIsOpen(!isOpen)}>
          {isOpen ? <Image className="w-20" src="/cross.svg" height="100" width="100" alt="logo" /> : <Image className="w-20" src="/greenBurger.svg" height="100" width="100" alt="logo" />}
        </div>
        {isOpen && (
